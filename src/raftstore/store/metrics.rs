...
lazy_static! {
    pub static ref PEER_PROPOSAL_COUNTER_VEC: IntCounterVec =
        register_int_counter_vec!(
            "tiflash_proxy_raftstore_proposal_total",
    ...
    pub static ref PEER_ADMIN_CMD_COUNTER_VEC: IntCounterVec =
        register_int_counter_vec!(
            "tiflash_proxy_raftstore_admin_cmd_total",
    ...
    pub static ref PEER_APPEND_LOG_HISTOGRAM: Histogram =
        register_histogram!(
            "tiflash_proxy_raftstore_append_log_duration_seconds",
    ...
    pub static ref PEER_COMMIT_LOG_HISTOGRAM: Histogram =
        register_histogram!(
            "tiflash_proxy_raftstore_commit_log_duration_seconds",
    ...
    pub static ref STORE_APPLY_LOG_HISTOGRAM: Histogram =
        register_histogram!(
            "tiflash_proxy_raftstore_apply_log_duration_seconds",
    ...
    pub static ref APPLY_TASK_WAIT_TIME_HISTOGRAM: Histogram =
        register_histogram!(
            "tiflash_proxy_raftstore_apply_wait_time_duration_secs",
    ...
    pub static ref STORE_RAFT_READY_COUNTER_VEC: IntCounterVec =
        register_int_counter_vec!(
            "tiflash_proxy_raftstore_raft_ready_handled_total",
    ...
    pub static ref STORE_RAFT_SENT_MESSAGE_COUNTER_VEC: IntCounterVec =
        register_int_counter_vec!(
            "tiflash_proxy_raftstore_raft_sent_message_total",
    ...
    pub static ref STORE_RAFT_DROPPED_MESSAGE_COUNTER_VEC: IntCounterVec =
        register_int_counter_vec!(
            "tiflash_proxy_raftstore_raft_dropped_message_total",
    ...
    pub static ref STORE_SNAPSHOT_TRAFFIC_GAUGE_VEC: IntGaugeVec =
        register_int_gauge_vec!(
            "tiflash_proxy_raftstore_snapshot_traffic_total",
    ...
    pub static ref STORE_SNAPSHOT_VALIDATION_FAILURE_COUNTER: IntCounterVec =
        register_int_counter_vec!(
            "tiflash_proxy_raftstore_snapshot_validation_failure_total",
    ...
    pub static ref PEER_RAFT_PROCESS_DURATION: HistogramVec =
        register_histogram_vec!(
            "tiflash_proxy_raftstore_raft_process_duration_secs",
    ...
    pub static ref PEER_PROPOSE_LOG_SIZE_HISTOGRAM: Histogram =
        register_histogram!(
            "tiflash_proxy_raftstore_propose_log_size",
    ...
    pub static ref REGION_HASH_COUNTER_VEC: IntCounterVec =
        register_int_counter_vec!(
            "tiflash_proxy_raftstore_hash_total",
    ...
    pub static ref REGION_MAX_LOG_LAG: Histogram =
        register_histogram!(
            "tiflash_proxy_raftstore_log_lag",
    ...
    pub static ref REQUEST_WAIT_TIME_HISTOGRAM: Histogram =
        register_histogram!(
            "tiflash_proxy_raftstore_request_wait_time_duration_secs",
    ...
    pub static ref PEER_GC_RAFT_LOG_COUNTER: IntCounter =
        register_int_counter!(
            "tiflash_proxy_raftstore_gc_raft_log_total",
    ...
    pub static ref SNAPSHOT_CF_KV_COUNT: HistogramVec =
        register_histogram_vec!(
            "tiflash_proxy_snapshot_cf_kv_count",
    ...
    pub static ref SNAPSHOT_CF_SIZE: HistogramVec =
        register_histogram_vec!(
            "tiflash_proxy_snapshot_cf_size",
    ...
    pub static ref SNAPSHOT_BUILD_TIME_HISTOGRAM: Histogram =
        register_histogram!(
            "tiflash_proxy_snapshot_build_time_duration_secs",
    ...
    pub static ref SNAPSHOT_KV_COUNT_HISTOGRAM: Histogram =
        register_histogram!(
            "tiflash_proxy_snapshot_kv_count",
    ...
    pub static ref RAFT_ENTRY_FETCHES: IntCounterVec =
        register_int_counter_vec!(
            "tiflash_proxy_raftstore_entry_fetches",
    ...
    pub static ref LEADER_MISSING: IntGauge =
        register_int_gauge!(
            "tiflash_proxy_raftstore_leader_missing",
            "Total number of leader missed region"
        ).unwrap();

    pub static ref INGEST_SST_DURATION_SECONDS: Histogram =
        register_histogram!(
            "tiflash_proxy_snapshot_ingest_sst_duration_seconds",
    ...
    pub static ref RAFT_INVALID_PROPOSAL_COUNTER_VEC: IntCounterVec =
        register_int_counter_vec!(
            "tiflash_proxy_raftstore_raft_invalid_proposal_total",
    ...
    pub static ref RAFT_EVENT_DURATION: HistogramVec =
        register_histogram_vec!(
            "tiflash_proxy_raftstore_event_duration",
    ...
    pub static ref RAFT_READ_INDEX_PENDING_DURATION: Histogram =
        register_histogram!(
            "tiflash_proxy_raftstore_read_index_pending_duration",
    ...
    pub static ref RAFT_READ_INDEX_PENDING_COUNT: IntGauge =
        register_int_gauge!(
            "tiflash_proxy_raftstore_read_index_pending",
