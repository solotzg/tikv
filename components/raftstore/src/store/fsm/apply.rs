    ...
    W: WriteBatch + WriteBatchVecExt<E>,
{
    ...
    pub fn commit(&mut self, _delegate: &mut ApplyDelegate<E>) {
        unreachable!()
    }
    ...
    E: KvEngine,
{
    ...
    fn exec_raft_cmd<W: WriteBatch + WriteBatchVecExt<E>>(
        ...
        ctx: &mut ApplyContext<E, W>,
        req: &RaftCmdRequest,
    ) -> Result<(RaftCmdResponse, ApplyResult<E::Snapshot>, TiFlashApplyRes)> {
    ...
    E: KvEngine,
{
    ...
    fn handle_ingest_sst_for_tiflash<W: WriteBatch + WriteBatchVecExt<E>>(
        &mut self,
        ...
        for sst in ssts {
            ...
            let snap = gen_snap_kv_data_from_sst(cf_file_path, ctx.importer.key_manager.clone());
